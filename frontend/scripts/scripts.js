...
function updateCartDisplay() {
    ...
    if (cartItems.length === 0) {
        ...
        orderSummaryItemsContainer.innerHTML = '<li class="list-group-item text-center">Your order summary is empty</li>';
    } else {
        cartItems.forEach((item, index) => {
            ...
            orderSummaryItem.className = 'list-group-item d-flex justify-content-between align-items-center';
